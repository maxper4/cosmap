...
function createBaseGenesisState(): GenesisState {
  return { params: undefined, systemInfo: undefined, eventsList: [] };
}
...
export const GenesisState = {
  encode(
    ...
    for (const v of message.eventsList) {
      Events.encode(v!, writer.uint32(26).fork()).ldelim();
    }
    return writer;
  },
  ...
  fromJSON(object: any): GenesisState {
    return {
      ...
      systemInfo: isSet(object.systemInfo)
        ...
        : undefined,
      eventsList: Array.isArray(object?.eventsList)
  ...
  toJSON(message: GenesisState): unknown {
    ...
    message.systemInfo !== undefined &&
      (obj.systemInfo = message.systemInfo
        ...
        : undefined);
    if (message.eventsList) {
      obj.eventsList = message.eventsList.map((e) =>
  ...
  fromPartial<I extends Exact<DeepPartial<GenesisState>, I>>(
    ...
    message.systemInfo =
      object.systemInfo !== undefined && object.systemInfo !== null
        ...
        : undefined;
    message.eventsList =
      object.eventsList?.map((e) => Events.fromPartial(e)) || [];
    return message;
  },
};
